...
namespace BaseApiApp.Framework.Cryptography
{
    ...
    /// </summary>
    public sealed class CryptoDES3
    {
        ...
        public static string Encrypt(string data, string key, string iv)
        {
            ...
            dynamic encStream = new CryptoStream(stream, des3.CreateEncryptor(bkey, biv), CryptoStreamMode.Write);
        ...
        public static string Decrypt(string data, string key, string iv)
        {
            ...
            dynamic stream = new MemoryStream();
            dynamic encStream = new CryptoStream(stream, des3.CreateDecryptor(bkey, biv), CryptoStreamMode.Write);
